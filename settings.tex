...
\usepackage{natbib}				
\renewcommand{\harvardurl}{\textbf{URL:} \url} % fix for url/doi
...
\newcommand{\detailtexcount}[1]{%
  \immediate\write18{texcount -merge -sum -sub=chapter -q #1.tex output.bbl > #1.wcdetail }%
  %\verbatiminput{#1.wcdetail}%
}

\newcommand{\quickwordcount}[2]{%
  \immediate\write18{texcount -1 -sum -merge -q #1.tex output.bbl > #1-words.sum }%
  \input{#1-words.sum} \hrulefill \xspace #2
}
