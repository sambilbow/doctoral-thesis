...
\begin{figure}
    ...
    \hfill
    \subcaptionbox{Through the viewport of `Virtual Sculpture' \citep[from][]{shaw1981}}[.32\linewidth]{\includegraphics[height=3cm]{07-polygons/shaw1981.jpg}}\label{fig: shaw1981}
