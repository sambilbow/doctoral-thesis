...
\section{The Augmented Reality Interface}
...
\subsection{Forms of AR}
\subsubsection{Head-mounted}
\begin{figure}
    \centering
    \subcaptionbox{Sutherlands `Ultimate Display'}[.3\linewidth]{\includegraphics[height=2.5cm]{c_2/sutherland68_1.png}}
    \label{fig: historicalHMDs-sutherland}
    \hfill
    \subcaptionbox{Caudell and Mizell's `HUDset'}[.3\linewidth]{\includegraphics[height=2.5cm]{c_2/caudell92_2.jpeg}}
    \label{fig: historicalHMDs-caudell}
    \hfill
    \subcaptionbox{Feiner's `KARMA' System}[.3\linewidth]{\includegraphics[height=2.5cm]{c_2/feiner93_1.png}}%
    \label{fig: historicalHMDs-feiner}
...
\begin{figure}
    \centering
    \subcaptionbox{Microsoft Hololens 2}{\includegraphics[width=0.45\linewidth]{c_2/hololens.jpg}}
    \label{fig: contemporaryHMDs-microsoft}\quad
    \hfill
    \subcaptionbox{Magic Leap ML-1}{\includegraphics[width=0.45\linewidth]{c_2/magicleap.png}}
    \label{fig: contemporaryHMDs-magicleap}\\
    \vspace{0.5cm}
    \subcaptionbox{nReal Light}{\includegraphics[width=0.45\linewidth]{c_2/nreal.png}}
    \label{fig: contemporaryHMDs-nreal}\quad
    \hfill
    \subcaptionbox{Leap Motion Project North Star}{\includegraphics[width=0.45\linewidth]{c_2/northstar.png}}
    \label{fig: contemporaryHMDs-northstar}\\
...
\subsection{Sensory Display in AR}
...
\subsubsection{The Chemical Senses}
...
\subsection{Computationally Mediated Realities: The AR Process}
\label{ssec: mediated realities}
...
% ----- Arts
% ------------------------- %
\section{Augmented Reality in the Arts}
...
\subsection{Aesthetic Experience}
...
\subsection{Collaborative Expression}
...
\begin{figure}
    \centering
    \subcaptionbox{Listening Mirrors}{\includegraphics[width=0.45\linewidth]{c_2/chevalier18_1.png}}
    \label{fig: collaborativeARt-listeningmirrors}
    \hfill
    \subcaptionbox{Bloom: Space}{\includegraphics[width=0.45\linewidth]{c_2/bloom.png}}
    \label{fig: collaborativeARt-bloom}
    \caption{Collaborative Expression in AR}
    \label{fig: collaborativeARt}
\end{figure}

\subsection{Activism and Agency}
...
\begin{figure}
    \centering
    \subcaptionbox{Manifest.AR MoMA Invasion}{\includegraphics[width=0.45\linewidth]{c_2/moma.jpg}}
    \label{fig: activismARt-moma}
    \hfill
    \subcaptionbox{Invisible Istanbul}{\includegraphics[width=0.45\linewidth]{c_2/thiel.jpg}}
    \label{fig: activismARt-istanbul}
...
% ----- Conclusion
% ------------------------- %
\subsection{An Arts Approach to Designing Multisensory AR}
