...
% ---------------------------------------------
\section{Design Patterns for AR Art and Music} \label{sec: discussion-patterns} % The XRt Space acknowledge own resistance and how it leads to bias? guidelines for accessibility etc
...
\begin{figure}
    \centering
    \subcaptionbox{\textit{"The Pusher / The Entertainment"} \citeyearpar{matsuda2009}}[.2\linewidth]{\includegraphics[height=2.5cm]{08-discussion/matsuda2009.png}}
    \hfill
    \subcaptionbox{\textit{"Augmented (hyper)Reality: Domestic Robocop"} \citeyearpar{matsuda2010}}[.2\linewidth]{\includegraphics[height=2.5cm]{08-discussion/matsuda2010.png}} \\
    \vspace{0.5cm}
    \subcaptionbox{\textit{"HYPER-REALITY"} \citeyearpar{matsuda2016}}[.2\linewidth]{\includegraphics[height=2.5cm]{08-discussion/matsuda2016.png}}
    \hfill
    \subcaptionbox{\textit{"Merger"} \citeyearpar{matsuda2019}}[.2\linewidth]{\includegraphics[height=2.5cm]{08-discussion/matsuda2019.png}}
