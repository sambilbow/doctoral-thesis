...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.75\linewidth]{06-polaris/polaris-clip_5}
    \captionsetup{justification=centering,margin=1.5cm}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.75\linewidth]{06-polaris/polaris-clip_6}
    \captionsetup{justification=centering,margin=1.5cm}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.75\linewidth]{06-polaris/polaris-clip_7}
    \captionsetup{justification=centering,margin=1.5cm}
