...
\noindent \textbf{polaris\textasciitilde{} Publication } \url{https://doi.org/10.21428/92fbeb44.8abb9ce6}

\vspace*{2cm}

\begin{figure}[!ht]
    
    \includegraphics[width=0.7\linewidth]{06-polaris/polaris-participant.png}
    \caption{Experience Study of \textit{polaris\textasciitilde{}} at the Sussex Humanities Lab}
    \label{fig: polaris-participant}
\end{figure}
