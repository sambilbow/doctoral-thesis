...
\begin{figure}
    ...
    \vspace{0.5cm}
    \subcaptionbox{nReal Light (XREAL predecessor) \citep[from][]{nreal2020}\label{fig: contemporaryHMDs-nreal}}{\includegraphics[width=0.45\linewidth]{02-review/nreal.png}}\quad
    \hfill
