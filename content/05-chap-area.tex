...
\begin{SingleSpace}   
    \begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}lr}
     \text{\faGithub}\quad\textbf{Code:}   & \text{\url{https://www.github.com/sambilbow/area}} \\
     \text{\faListOl}\quad\textbf{Guide:} & \text{\url{https://www.github.com/sambilbow/area/wiki}} \\
     \text{\faBook}\xspace\textbf{Publication:} &\text{\url{https://dx.doi.org/10.21428/66f840a4.b74711a8}} \\
     \text{\faFileArchiveO}\quad\textbf{Archive:} & \text{\autoref{sec: appendix-a}}
    \end{tabular*}
\end{SingleSpace}%
